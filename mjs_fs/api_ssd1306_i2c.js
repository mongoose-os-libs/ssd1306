...
let SSD1306 = {
    ...
    SSD1306_COLOR_INVERT: 2,   //< Invert pixel (XOR)
		...
		_getGlobal: ffi('void *mgos_ssd1306_get_global()'),
		_getWidth: ffi('int mgos_ssd1306_get_width(void *)'),
		_getHeight: ffi('int mgos_ssd1306_get_height (void *)'),
		_clear: ffi('mgos_ssd1306_clear (void *)'),
		_refresh: ffi('mgos_ssd1306_refresh (void *, bool)'),
	  _drawPixel: ffi('mgos_ssd1306_draw_pixel (void *, int, int, int)'),
		_drawHLine: ffi('mgos_ssd1306_draw_hline (void *, int, int, int, int)'),
		_drawVLine: ffi('mgos_ssd1306_draw_vline (void *, int, int, int, int)'),
		_drawRectangle: ffi('mgos_ssd1306_draw_rectangle (void *, int, int, int, int, int)'),
		_fillRectangle: ffi('mgos_ssd1306_fill_rectangle (void *, int, int, int, int, int)'),
		_drawCircle: ffi('mgos_ssd1306_draw_circle (void *, int, int, int, int)'),
		_fillCircle: ffi('mgos_ssd1306_fill_circle (void *, int, int, int, int)'),
		_selectFont: ffi('mgos_ssd1306_select_font (void *, int)'),
		...
		_invertDisplay: ffi('mgos_ssd1306_invert_display(void *, bool)'),
		_flipDisplay: ffi('mgos_ssd1306_flip_display(void *, bool, bool)'),
		_updateBuffer: ffi('mgos_ssd1306_update_buffer(void *, int *, int)'),
